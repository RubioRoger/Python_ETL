...
# REALIZA A EXTRAÇÃO DOS ARQUIVOS CSV DA PASTA ARQUIVOS
    def extract(self):
        ...
        file_list = glob(r"./arquivos/*PRODESP*.csv")
...
# INSERI INFORMAÇÕES NO BANCO DE DADOS E MIGRA OS ARQUIVOS DA PASTA ARQUIVOS PARA A PASTA OUTPUTS
    def insert(self):
        ...
        db.organizar_df('tb_prodesp_network_mes',df)

        db.deletar_informacoes('tb_prodesp_network_mes',df2)

        db.inserir_df('tb_prodesp_network_mes',df)
...
# EXECUTAS AS FUNÇÕES DO PROCESSO
    def __init__(self):
        ...
        try:
            ...
            sha.criar_pasta("prodesp", parent_path="Documents/etl_capacity")
            sha.criar_pasta("network", parent_path="Documents/etl_capacity/prodesp")
